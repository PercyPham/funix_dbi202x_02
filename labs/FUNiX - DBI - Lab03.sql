-- Câu 1. Hiển danh sách các khách hàng có điện thoại là 8457895 
...
-- Câu 2.Hiển danh sách các vật tư là “DA” (bao gồm các loại đá) 
...
-- Câu 3.Tạo query để lấy ra các thông tin gồm Mã hoá đơn, ngày lập hoá đơn, 
...
-- Câu 4.Lấy ra danh sách những khách hàng mua hàng trong tháng 6/2000 
...
-- Câu 5.Tạo query để lấy ra các chi tiết hoá đơn gồm các thông tin mã hóa đơn, 
-- mã vật tư, tên vật tư, giá bán, giá mua, số lượng , trị giá mua (giá mua * số lượng),
-- trị giá bán , (giá bán * số lượng), tiền lời (trị giá bán – trị giá mua) mà có giá bán lớn hơn hoặc bằng giá mua.
...
-- Số hoá đơn, ngày, tên khách hàng, địa chỉ khách hàng, tổng trị giá của hoá đơn.
...
-- Chú ýVT Có thể có những vật tư chưa bán được đơn vị nào, khi đó cần hiển thị là đã bán 0 đơn vị.
SELECT VT.MAVT,VT.TENVT, isnull(sl.TongSL, 0) AS 'Tong don vi da ban'
FROM VATTU as VT
LEFT JOIN (
